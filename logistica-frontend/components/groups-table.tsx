...
import { Pencil, Trash2, ChevronLeft, ChevronRight, Shield } from "lucide-react"
...
export function GroupsTable({
    ...
    () => [
      ...
      columnHelper.accessor("permissions", {
        ...
        cell: ({ getValue }) => {
          ...
          return <span className="text-sm text-muted-foreground">{count} permiso{count !== 1 ? "s" : ""}</span>
        },
      }),
  ...
  const table = useReactTable({
    ...
    state: { sorting, pagination: { pageIndex: page - 1, pageSize: 20 } },
